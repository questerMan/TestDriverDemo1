...
//    CutomTabBar * tabBar = [[CutomTabBar alloc]init];
//    
//    [tabBar creatViewCotrollers:@[@"MainVC",@"GroundVC",@"MineVC"] andTabBarItemTitile:@[@"主页",@"群聊",@"我的"] andTabBarItemImage:@[@"main",@"chat",@"mine"] andTabBarItemSelectedImage:@[@"main",@"chat",@"mine"]];
//    
//
